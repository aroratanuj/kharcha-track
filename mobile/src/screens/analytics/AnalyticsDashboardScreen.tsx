    ...
    <View style={[s.outer, { backgroundColor: colors.bg }]}>
      <View style={[s.screenBorder, { backgroundColor: colors.surface, borderColor: colors.screenBorder }]}>
        <View style={s.content}>
          ...
          <Text style={[s.subtitle, { color: colors.textMuted }]}>View your spending patterns</Text>
          <View style={[s.card, { backgroundColor: colors.card, borderColor: colors.border }]}>
            <Text style={[s.cardText, { color: colors.textMuted }]}>Charts and reports are in progress...</Text>
          </View>
        </View>
      </View>
    </View>
